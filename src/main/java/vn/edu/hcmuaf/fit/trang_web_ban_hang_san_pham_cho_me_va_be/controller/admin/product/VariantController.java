...
//import vn.edu.hcmuaf.fit.trang_web_ban_hang_san_pham_cho_me_va_be.model.VariantValue;
        ...
        try {
            if (pathInfo == null || pathInfo.equals("/")) {
                ...
                if (pathParts.length == 2 && isNumeric(pathParts[1])) {
                    ...
                    List<Variant> variantValues = variantService.getVariantValuesByVariantId(id);
