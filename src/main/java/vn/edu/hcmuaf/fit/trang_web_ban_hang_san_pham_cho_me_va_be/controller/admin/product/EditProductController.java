    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            boolean updateSuccess = productService.updateProduct(
                    ...
                    Integer.parseInt(productData.get("category_id").toString()),
                    Integer.parseInt(productData.get("brand_id").toString()),
                    productData.get("image_url") != null ? Integer.parseInt(productData.get("image_url").toString()) : null,
            ...
            // Cập nhật options (OptionVariant) nếu có
            if (productData.containsKey("OptionVariant")) {
                List<Map<String, Object>> options = (List<Map<String, Object>>) productData.get("OptionVariant");
