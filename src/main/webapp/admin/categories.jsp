...
<head>
    ...
    <script
            src="${pageContext.request.contextPath}/static/style-component/style-admin/categories/categories1.js"
            defer></script>
        ...
        <div class="toolbar">
            ...
            <div id="add-category-box" class="hidden">
                ...
                <input type="text" id="category-name" name="categoryName"
                       placeholder="Nhập tên danh mục" class="input-field" required />
            ...
            <div id="edit-category-box" class="hidden">
                <h3>Sửa Danh Mục</h3>
                <input type="hidden" id="edit-category-id" />
                <input type="text" id="edit-category-name" name="editCategoryName"
                       placeholder="Nhập tên danh mục" class="input-field" required />
                <div id="edit-error-message" class="error hidden">Tên danh mục không được để trống</div>

                <div class="action-buttons">
                    <button class="add-btn update-cate-btn" id="update-category-btn">Cập Nhật</button>
                    <button class="discard-btn" id="discard-edit-btn">Hủy</button>
                </div>
            </div>
                            ...
                            <div class="action-icons">
                                <div class="dropdown">
                                    <button onclick="toggleDropdown(this)">
                                        <i class="fa-solid fa-pen-to-square icon-xs"
                                           style="padding: 5px;"></i>
                                    ...
                                    <div class="dropdown-content">
                                                            ...
                                                            <span class="icon edit-icon" data-id="${category.id}"
