        ...
        <div class="slideshow-container">
                        ...
                        <table class="table table-thead-bordered table-nowrap table-align-middle">
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    <div class="mb-1">
                                        <img class="avatar avatar-xs"
                                             src="../../webapp/static/image/oc-email-at.svg"
                                ...
                                <th class="text-center">
                                    <div class="mb-1">
                                        <img class="avatar avatar-xs"
                                             src="../../webapp/static/image/oc-globe.svg"
                                ...
                                <th class="text-center">
                                    <div class="mb-1">
                                        <img class="avatar avatar-xs"
                                             src="../../webapp/static/image/oc-phone.svg"
            ...
            <div class="content connected-accounts" id="connected-accounts">
                ...
                <div class="account-info">
                    <img class="avatar-xs" src="../../webapp/static/image/google-icon.svg"
                ...
                <div class="account-info">
                    <img class="avatar-xs" src="../../webapp/static/image/spec-icon.svg"
                         alt="Biểu tượng Spec">
                    <div class="account-details">
                        <h4>Spec</h4>
                        <p>Quản lý dự án</p>
                ...
                <div class="account-info">
                    <img class="avatar-xs" src="../../webapp/static/image/slack-icon.svg"
                ...
                <div class="account-info">
                    <img class="avatar-xs" src="../../webapp/static/image/mailchimp-icon.svg"
            ...
            <div class="content social-accounts" id="social-accounts">
                ...
                <div class="account-info">
                    <div class="account-details">
                        <i class="fa-brands fa-twitter account-icon"></i>
                        <div>
                ...
                <div class="account-info">
                    <div class="account-details">
                        <i class="fa-brands fa-facebook account-icon"></i>
                        <div>
                ...
                <div class="account-info">
                    <div class="account-details">
                        <i class="fab-brands fa-slack account-icon"></i>
                        <div>
                            <strong>Slack</strong>
                            <p>Chưa kết nối</p>
                        </div>
                ...
                <div class="account-info">
                    <div class="account-details">
                        <i class="fab-brands fa-linkedin account-icon"></i>
                        <div>
